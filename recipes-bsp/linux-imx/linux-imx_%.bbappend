...
do_after_patch() {
	...
	# AESYS 2415A
	cp "${COPYSOURCE}/aesys_2414a+aesys_2415a.dts" "${WORKDIR}/git/arch/arm64/boot/dts/freescale"

	# AESYS 2501A
	cp "${COPYSOURCE}/aesys_2414a+aesys_2501a.dts" "${WORKDIR}/git/arch/arm64/boot/dts/freescale"
}
